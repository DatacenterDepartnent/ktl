...
exports.LayoutGrid = function (_a) {
    ...
    return (react_1["default"].createElement("div", { className: "w-full h-full p-10 grid grid-cols-1 md:grid-cols-3  max-w-7xl mx-auto gap-4 relative" },
        cards.map(function (card, i) { return (react_1["default"].createElement("div", { key: i, className: utils_1.cn(card.className, "") },
            react_1["default"].createElement(framer_motion_1.motion.div, { onClick: function () { return handleClick(card); }, className: utils_1.cn(card.className, "relative overflow-hidden", (selected === null || selected === void 0 ? void 0 : selected.id) === card.id
                    ...
                    : (lastSelected === null || lastSelected === void 0 ? void 0 : lastSelected.id) === card.id
                        ...
                        : "bg-white rounded-xl h-full w-full"), layoutId: "card-" + card.id },
        ...
        react_1["default"].createElement(framer_motion_1.motion.div, { onClick: handleOutsideClick, className: utils_1.cn("absolute h-full w-full left-0 top-0 bg-black opacity-0 z-10", (selected === null || selected === void 0 ? void 0 : selected.id) ? "pointer-events-auto" : "pointer-events-none"), animate: { opacity: (selected === null || selected === void 0 ? void 0 : selected.id) ? 0.3 : 0 } })));
};
var ImageComponent = function (_a) {
    var card = _a.card;
    return (react_1["default"].createElement(framer_motion_1.motion.img, { layoutId: "image-" + card.id + "-image", src: card.thumbnail, height: "500", width: "500", className: utils_1.cn("object-cover object-top absolute inset-0 h-full w-full transition duration-200"), alt: "thumbnail" }));
};
var SelectedCard = function (_a) {
    var selected = _a.selected;
    return (react_1["default"].createElement("div", { className: "bg-transparent h-full w-full flex flex-col justify-end rounded-lg shadow-2xl relative z-[60]" },

    ...
    <section className="py-16 ">
      <div className="container mx-auto px-4 lg:px-20 ">
        ...
        >
          ...
          >
            <article className="relative bg-white flex h-full flex-col items-center justify-center rounded-3xl border border-slate-200  p-8 text-center shadow-sm transition-all duration-300 hover:-translate-y-2 hover:border-blue-200 hover:shadow-xl hover:shadow-blue-500/10">
              {/* Decorative Icon Background */}
              <div className="absolute top-0 right-0 -mt-4 -mr-4 h-24 w-24 rounded-full bg-blue-50 opacity-50 blur-2xl transition-opacity group-hover:opacity-100" />

              <div className="relative mb-6">
                <div className="flex h-24 w-24 items-center justify-center rounded-full bg-blue-50 p-4 transition-transform duration-500 group-hover:scale-110">
                  <Image
              ...
              <h3 className="mb-3 text-xl font-bold text-slate-800 transition-colors group-hover:text-blue-600">
          ...
          <Link
            ...
            className="group block h-full"
          >
            <article className="relative bg-white flex h-full flex-col items-center justify-center rounded-3xl border border-slate-200  p-8 text-center shadow-sm transition-all duration-300 hover:-translate-y-2 hover:border-cyan-200 hover:shadow-xl hover:shadow-cyan-500/10">
              {/* Decorative Icon Background */}
              <div className="absolute bottom-0 left-0 -mb-4 -ml-4 h-24 w-24 rounded-full bg-cyan-50 opacity-50 blur-2xl transition-opacity group-hover:opacity-100 " />

              <div className="relative mb-6">
                <div className="flex h-24 w-24 items-center justify-center rounded-full bg-cyan-50 p-2 transition-transform duration-500 group-hover:scale-110">
                  <Image
              ...
              <h3 className="mb-3 text-xl font-bold text-slate-800 transition-colors group-hover:text-cyan-600">

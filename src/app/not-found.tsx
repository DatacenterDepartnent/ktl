...
const ErrorContent = () => {
  ...
  return (
    ...
    >
      <section className="relative flex max-w-[1600px] py-60 mx-auto items-center justify-center overflow-hidden bg-slate-50 dark:bg-zinc-950 transition-colors duration-300">

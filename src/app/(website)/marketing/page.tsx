                ...
                <div className="flex h-full flex-col">
                  ...
                  <div className="relative mb-5 overflow-hidden rounded-xl bg-slate-100 dark:bg-zinc-800">
                    ...
                    <div className="absolute inset-0 flex items-center justify-center bg-black/20 opacity-0 transition-opacity duration-300 group-hover:opacity-100">
                      <FundFilled className="text-3xl text-white drop-shadow-md" />
                    </div>
                  </div>

                  {/* Content */}
                  <div className="flex flex-1 flex-col text-center">
                    <h3 className="text-lg font-bold text-slate-800 transition-colors group-hover:text-rose-500 dark:text-white dark:group-hover:text-rose-400">
                      {item.name}
                    </h3>

                    <p className="mb-3 mt-1 text-sm font-semibold text-rose-500">
                      {item.position}
                    </p>

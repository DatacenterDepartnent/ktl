                ...
                <div className="flex h-full flex-col">
                  ...
                  <div className="relative mb-5 overflow-hidden rounded-xl bg-slate-100 dark:bg-zinc-800">
                    <div className="aspect-[3/4] w-full">
                      <Image
                        src={item.img}
                        alt={item.name || "บุคลากรอิเล็กทรอนิกส์"}
                    ...
                    <div className="absolute inset-0 flex items-center justify-center bg-black/20 opacity-0 transition-opacity duration-300 group-hover:opacity-100">
                      <ThunderboltFilled className="text-3xl text-white drop-shadow-md" />
                    </div>
                  </div>

                  {/* Content */}
                  <div className="flex flex-1 flex-col text-center">
                    <h3 className="text-lg font-bold text-slate-800 transition-colors group-hover:text-cyan-600 dark:text-white dark:group-hover:text-cyan-400">
                      {item.name}
                    </h3>

                    <p className="mb-3 mt-1 text-sm font-semibold text-cyan-600 dark:text-cyan-500">
                      {item.position}
                    </p>

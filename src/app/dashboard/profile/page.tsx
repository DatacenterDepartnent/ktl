...
export default function ProfilePage() {
  ...
  if (loading) return <div className="p-20 text-center font-bold text-zinc-400 animate-pulse">กำลังโหลดข้อมูล...</div>;
    ...
    <div className="max-w-5xl mx-auto px-6 py-12">
      ...
      <div className="flex flex-col md:flex-row md:items-end justify-between gap-6 mb-12 border-b border-zinc-200 dark:border-zinc-800 pb-10">
        <div className="space-y-2">
          ...
          <p className="text-zinc-500 font-medium italic">จัดการข้อมูลส่วนตัวและรูปโปรไฟล์ของคุณ</p>
        </div>
      </div>
      ...
      <form onSubmit={handleSubmit} className="grid grid-cols-1 lg:grid-cols-3 gap-8">
        ...
        <div className="lg:col-span-1">
          <div className="bg-white dark:bg-zinc-900 border border-zinc-200 dark:border-zinc-800 p-8 rounded-[2.5rem] shadow-sm flex flex-col items-center text-center">
            ...
            <div className="mt-6">
              <h2 className="text-xl font-black text-zinc-900 dark:text-white leading-none">{formData.username}</h2>
        ...
        <div className="lg:col-span-2 space-y-6">
          <div className="bg-white dark:bg-zinc-900 border border-zinc-100 dark:border-zinc-800 p-8 rounded-[2.5rem] shadow-sm">
            <h3 className="text-sm font-black uppercase tracking-widest text-zinc-400 mb-6 flex items-center gap-2">
               <span className="w-1.5 h-4 bg-blue-600 rounded-full" /> Personal Information
            </h3>
            
            <div className="grid grid-cols-1 md:grid-cols-2 gap-5">
              <div className="md:col-span-2">
                <label className="text-[10px] font-black uppercase tracking-widest text-zinc-400 ml-2 mb-2 block">ชื่อ-นามสกุล</label>
                <input
                  type="text"
                  value={formData.name}
              ...
              <div>
                <label className="text-[10px] font-black uppercase tracking-widest text-zinc-400 ml-2 mb-2 block">เบอร์โทรศัพท์</label>
                <input
                  type="tel"
              ...
              <div>
                <label className="text-[10px] font-black uppercase tracking-widest text-zinc-400 ml-2 mb-2 block">Line ID</label>
                <input
                  type="text"
              ...
              <div className="md:col-span-2">
                <label className="text-[10px] font-black uppercase tracking-widest text-zinc-400 ml-2 mb-2 block">อีเมล</label>
                <input
                  type="email"
          ...
          <div className="bg-white dark:bg-zinc-900 border border-zinc-100 dark:border-zinc-800 p-8 rounded-[2.5rem] shadow-sm">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-5">
              <div>
                <label className="text-[10px] font-black uppercase tracking-widest text-zinc-400 ml-2 mb-2 block">รหัสผ่านใหม่</label>
                <input
                  type="password"
              ...
              <div>
                <label className="text-[10px] font-black uppercase tracking-widest text-zinc-400 ml-2 mb-2 block">ยืนยันรหัสผ่าน</label>
                <input
                  type="password"
          ...
          <div className="flex justify-end">
            <button
              ...
              className={`group flex items-center gap-3 px-10 py-4 rounded-[2rem] font-black text-white transition-all shadow-xl ${
                saving ? "bg-zinc-400 cursor-wait" : "bg-blue-600 hover:bg-blue-500 hover:shadow-blue-500/30 active:scale-95"
              }`}
            >
              {saving ? "SAVING..." : (
                <>

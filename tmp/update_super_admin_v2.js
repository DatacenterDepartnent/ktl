...
const newMajors = `<optgroup label="๔. ฝ่ายวิชาการ (ปวช.)">
...
const pattern = /<optgroup label="๔\. ฝ่ายวิชาการ \(ปวช\.\)">[^]*?<\/optgroup>/;
if (pattern.test(content)) {
    const newContent = content.replace(pattern, newMajors);
    fs.writeFileSync(path, newContent, 'utf8');
    console.log("Updated successfully with regex");
} else {

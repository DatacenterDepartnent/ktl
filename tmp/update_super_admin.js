...
const startTag = '<optgroup label="๔. ฝ่ายวิชาการ (ปวช.)">';
const endTag = '</optgroup>';
...
const newContent = content.substring(0, startIndex) + startTag + newMajors + content.substring(endIndex);
